...
Shape pressure, `2^n` Bit represents point `X` `2^n 2^n`. Whether there is a perfect match for the subsets, each time the Y-square point is enumerated, a solution to the X-square point is connected.
